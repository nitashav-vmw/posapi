...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=nitashav-vmw&repo=posapi",
  "namespace" : "nitashav",
  "projectName" : "posapi",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->posapi]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=nitashav-vmw&repo=posapi'
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [new-namespace->nitashav, fiserv-accelerator->posapi]
